...
namespace TORACREDITAPI
{
	...
	public:
		...
		static CTORATstpTraderApi *CreateTstpTraderApi(const char *pszFlowPath = "", bool bEncrypt = false, TTORATstpTradeCommModeType eTradeCommMode = TORA_TSTP_TCM_TCP, const char *pszInterfaceAddr = "");
